...
@section('content')
<div class="max-w-7xl mx-auto px-6 py-12 space-y-10 bg-black text-white font-sans">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <button onclick="openModal()" 
            class="bg-emerald-500 hover:bg-emerald-400 text-black rounded-2xl font-black text-lg transition-all flex flex-col items-center justify-center p-4 shadow-[0_10px_30px_rgba(16,185,129,0.3)] active:scale-95">
...
<script>
    ...
    // Menutup modal jika klik area hitam di luar kotak

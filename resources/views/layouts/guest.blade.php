...
<body class="font-sans antialiased text-white selection:bg-emerald-500 selection:text-white bg-[#050B14]">
    ...
    <div class="min-h-screen relative z-10 flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <div>
            <a href="/"
                class="text-4xl font-black text-white tracking-tight hover:text-emerald-400 transition-colors flex items-center gap-3">
                <div
                    class="w-12 h-12 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(16,185,129,0.4)]">
                    <svg class="w-7 h-7 text-[#050B14]" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        stroke-width="2.5">
        ...
        <div
            class="w-full sm:max-w-md mt-6 px-8 py-10 bg-white/5 backdrop-blur-xl shadow-2xl border border-white/10 overflow-hidden sm:rounded-[2rem]">
            {{ $slot }}
        </div>
    </div>
</body>
